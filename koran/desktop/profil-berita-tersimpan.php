	...
	<div class="container small left padding-no">
            ...
            <h2 class="titlebox">Tempo.co</h2>
                <div class="card-box ft240 margin-bottom-sm">
                    ...
                    <article class="text-card">
                        <h2 class="title fw6 fo18"><a href="detail-news.php">UEFA Ubah Aturan Anggaran Gaji Pasca Lionel Messi Hengkang, Barcelona Gigit Jari</a></h2>
        ...
        <path d="M8.52344 13.6219L13.977 17.1278" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="card-box ft240 margin-bottom-sm">
                    ...
                    <article class="text-card">
                        <h2 class="title fw6 fo18"><a href="detail-news.php">Cina Sediakan Vaksin COVID-19 untuk Warganya di Luar Negeri dan Atlit Olimpiade</a></h2>
                        <h4 class="date">5 Menit Lalu</h4>
                        <div class="box-bottom-icons margin-top-sm">
                            <a  href="#hapus-berita" data-effect="mfp-zoom-out" class="buka-popup bottom-link">
                            <div class="icon-bot"><svg class="svg-light" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.52344 13.6219L13.977 17.1278" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="card-box ft240 margin-bottom-sm">
                    ...
                    <article class="text-card">
                        <h2 class="title fw6 fo18"><a href="detail-news.php">Mile 72 hingga Mile 73 Sempat Ditutup karena Banjir, Freeport: Tak Ada Kerusakan</a></h2>
                        <h4 class="date">5 Menit Lalu</h4>
                        <div class="box-bottom-icons margin-top-sm">
                            <a href="#hapus-berita" data-effect="mfp-zoom-out" class="buka-popup bottom-link">
                            <div class="icon-bot"><svg class="svg-light" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.52344 13.6219L13.977 17.1278" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="card-box"><div class="text-card"><p class="fo14 ffos margin-top-no">Belum ada berita tersimpan</p></div></div>
            </div>
        </main>
    </div>
</main>
