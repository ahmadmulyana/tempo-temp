...
/*
$('.buka-daftar, .buka-login, .buka-forgot, .buka-edit-data-diri, .buka-edit-telepon, .buka-edit-sandi, .buka-edit-topik, .buka-hapus-berita, .buka-tanggal-tahun').magnificPopup({
  closeBtnInside:true,
  removalDelay: 500,
    callbacks: {
    beforeOpen: function() {
...
var width = window.innerWidth || document.documentElement.clientWidth;
	if (width > 100) {
		$(".skinads-left").stick_in_parent({offset_top:95});
		$(".skinads-right").stick_in_parent({offset_top:95});
