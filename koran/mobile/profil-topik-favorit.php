...
<main class="cd-main-content nomenu" style="display:flex; flex:1;">
	<div class="container overflow padding-top-sm">
		<div class="box-inside noborder padding-no centering column" style="min-height:100vh;s">
            <h2 class="title margin-bottom-sm t-center">Belum Ada Topik</h2>
            ...
            <a href="edit-topik-favorit.php" class="sign-btn medium bg-black cl-white radius4">Atur Sekarang</a>
