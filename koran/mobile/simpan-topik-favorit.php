...
<main class="cd-main-content nomenu fxbot" style="display:flex; flex:1;">
	<div class="container overflow padding-top-sm">
		<div class="box-inside noborder padding-no">
            <p class="f18 margin-bottom-sm">Daftar Topik pilihan Anda, yang kami gunakan untuk menyajikan berita sesuai dengan minat Anda.</p>
            ...
            <div class="fixed-bottom">
				<a href="edit-topik-favorit.php" class="sign-btn medium bg-black cl-white radius4">Ubah</a>
            </div>
        </div>
    </div>
</main>
