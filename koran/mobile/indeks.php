...
<main class="cd-main-content nomenu" style="display:flex; flex:1;">
	<div class="container overflow">
        <div class="blockbox overflow margin-top-xs margin-bottom-no">
        ...
        <main class="main-full">
            <div class="container-col margin-bottom-sm overflow">
                ...
                <input type="date" class="element-input medium noicons radius2 margin-right-xs">
                </div>
                </div>
