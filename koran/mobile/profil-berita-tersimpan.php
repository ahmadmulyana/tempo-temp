...
<body>
	<header class="header alt">
		<div class="top-head"><h1 class="title">Berita Tersimpan</h1></div>
	</header>
<main class="cd-main-content nomenu" style="display:flex; flex:1;">
	<div class="container overflow padding-top-sm">
		<div class="margin-bottom-sm">
            <div class="element-box">
                <select name="cars" id="pekerjaan" class="element-select medium noicons fw400">
            ...
            <div class="card-box sq102 margin-bottom-sm">
                ...
                <article class="text-card">
                    ...
                    <div class="box-bottom-icons margin-top-sm">
                        <a href="#hapus" data-effect="mfp-zoom-out" class="buka-popup bottom-link">
...
<div id="hapus" class="white-popup-block smaller mfp-with-anim mfp-hide" style="min-height:189px;">
