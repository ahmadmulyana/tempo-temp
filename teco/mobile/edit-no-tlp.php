...
<?php include 'includes/kumpulan-popup.php';?>
	<header class="header alt">
		<div class="top-head"><h1 class="title">Ubah No. Telepon</h1></div>
	</header>
    	...
    	<div class="container-col">
        	<div class="col12">
				<div class="box-inside overflow noborder padding-no margin-bottom-lg">
                    <label class="medium">No. Telepon</label>
                    <div class="element-box">
                        <input type="text" class="element-input medium noicons darkline radius2" value="0898767635">
                    </div>
                </div>
            </div>
