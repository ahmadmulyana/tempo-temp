...
<main class="cd-main-content nomenu">
	<div class="container overflow">
        ...
        <main class="main-full">
            <div class="blockbox overflow margin-bottom-no margin-top-xs">
                <h1 class="titlebox">Video</h1>
				<div class="card-box margin-bottom-sm">
                	<figure class="img-card"><a href="detail-video.php"><div class="bottom-label-right">03:12</div><img src="foto/foto01.jpg"></a></figure>
                        <article class="text-card padding-no">
                        	<h3 class="title"><a href="detail-video.php">UEFA Ubah Aturan Anggaran Gaji Pasca Lionel Messi Hengkang, Barcelona Gigit Jari</a></h3>
            ...
            <div class="blockbox overflow margin-bottom-xs">
                ...
                <div class="card-box margin-bottom-sm">
                    <figure class="img-card"><a href="detail-video.php"><div class="bottom-label-right">03:12</div><img src="foto/foto03.jpg" alt="deskripsi gambar"></a></figure>
                    <article class="text-card padding-top-no">
			...
			</div> <!-- end video bisnis -->
            <div class="container-col margin-bottom-sm">
            	<div class="bannerfull"><img src="banner/banner300x250.png" class="b300x250"></div>
            </div>
			<div class="blockbox overflow margin-bottom-no">
